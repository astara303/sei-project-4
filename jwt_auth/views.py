...
from .serializers import UserSerializer, CommentSerializer, PopulatedProfileSerializer
User = get_user_model()
...
class UserListView(APIView):
    ...
    def get(self, _request):
        ...
        serialized_users = PopulatedProfileSerializer(users, many=True)
...
class UserProfileView(APIView):
    ...
    def get(self, _request, pk):
        ...
        try:
            ...
            serialized_user = PopulatedProfileSerializer(user)
