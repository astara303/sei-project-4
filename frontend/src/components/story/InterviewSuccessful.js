            ...
            <Card style={{ width: '35rem' }}>
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  <p className="add-margin">"And we would be so pleased to offer you a place on our team."</p>
                  <p className="add-margin">Your mind goes blank. Is this what it feels like to go into shock? A strange numbness washes over you.</p>
                  <p className="add-margin">As the feeling comes back to your fingers, you're not sure how long you've been quiet.</p>
                  <p className="add-margin">"Wow, that's great, thank you so much!" you manage to sputter out.</p>
                  ...
                  <p className="add-margin">"It was a pleasure meeting you as well. I can't wait to start. Thank you!"</p>
