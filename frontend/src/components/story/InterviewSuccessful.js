            ...
            <Card style={{ width: '50rem' }}>
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  <p className="add-margin">"Hello there! I wanted to thank you so much for interviewing with our company. We really enjoyed meeting you-" Your heart doesn't know whether to fly or sink. Is this a gentle let down or are they setting you up for good news? They continue, "...and we would be so pleased to offer you a place on our team." Your mind goes blank. Is this what it feels like to go into shock? A strange numbness washes over you.</p>
                  <p className="add-margin">As the feeling comes back to your fingers, you're not sure how long you've been quiet. Wow, that's great, thank you so much!" you manage to sputter out.</p>
                  <p className="add-margin">"We'll be in touch soon with the details. Great job on the interview. We're really looking forward to you joining us."</p>
                  <p className="add-margin">"It was a pleasure meeting you as well. I can't wait to start. Thank you!" You hang up the phone and take a deep breath. You always knew you could do it.</p>
